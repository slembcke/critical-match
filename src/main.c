...
static GameState final_score(s16 scroll_v){
	static const u8 ATTRIB[64] = {
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xAF, 0xAF, 0xAF, 0xAF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xAA, 0xAA, 0xAA, 0xAA, 0xFF, 0xFF,
		0xFF, 0xFF, 0xAA, 0xAA, 0xAA, 0xAA, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFA, 0xFA, 0xFA, 0xFA, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	};
...
static GameState main_menu(void){
	static const u8 ATTRIB[64] = {
		...
		0x00, 0x44, 0x55, 0x55, 0x55, 0x55, 0x11, 0x00,
		0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5,
		0xFF, 0xAF, 0xAF, 0xAF, 0xAF, 0xAF, 0xAF, 0xFF,
		0xFF, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xFF,
		0xFF, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xFF,
	};
