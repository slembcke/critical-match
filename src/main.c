...
static GameState game_loop(void){
	...
	px_ppu_sync_off(); {
		...
		static const u8 ATTRIB[64] = {
			...
			0xFF, 0xFF, 0xBF, 0xAF, 0xAF, 0xEF, 0xFF, 0xFF,
			0xFF, 0xAA, 0xBB, 0xAA, 0xAA, 0xEE, 0xFF, 0xFF,
			0xFF, 0xFF, 0xBB, 0xAA, 0xAA, 0xEE, 0xFF, 0xFF,
			0xFF, 0xBB, 0xBB, 0xAA, 0xAA, 0xEE, 0xFE, 0xFF,
			0xFF, 0xFF, 0xBB, 0xAA, 0xAA, 0xEE, 0xFF, 0xFF,
			0xFF, 0xFF, 0xFB, 0xFA, 0xFA, 0xFE, 0xFF, 0xFF,
			0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		};
